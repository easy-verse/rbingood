...
const SPONSOR_I18N = {
  ru: {
    ...
    smb: {
      ...
      li3: 'ESG-метрики из реальных событий: вес отходов, площадь очистки, участники, часы работы',
      li4: 'Структура данных для ESG отчётов: ESRS S3-4 + reference к GRI 306',
      li5: 'Raw data для аудита: CSV-экспорт GPS-треков и метрик',
      li6: 'Готовый ESG Impact Report: в течение 2 недель после события',
      roi: 'Не CSR-истории. Доказательства реальных действий с evidence trail для аудитора.',
    ...
    hr: {
      ...
      li3: 'Контент для LinkedIn и внутренних коммуникаций',
      li4: 'Подтверждение участия сотрудников',
      li5: 'ESG Impact Report после события',
    ...
    pkg1: {
      ...
      price: '€950',
      sub1: 'Эко ивент €500',
      sub2: 'ESG-отчёт фикс. €450',
      li0: 'Тест ESG-доказательств',
      li1: '1 событие (2\u20133 часа) \u00b7 до 6 участников',
    ...
    pkg2: {
      ...
      name: 'Impact Heartbeat (Standard)',
      price: '€3,600',
      sub1: 'Эко ивент €450',
      sub2: 'ESG-отчёт фикс. €450',
      sub3: 'За событие –€50 → <b>€900</b>',
      li1: 'Самый популярный',
      li2: '4 события в год · до 8 участников',
      li3: 'ESG Data Pack после каждого события',
      li4: 'Годовое резюме импакта для отчёта',
      li5: 'Брендинг + фото/видео + приоритет дат',
      roi: 'Регулярные доказательства в течение года',
      btn: 'Запросить предложение'
    },
    pkg3: {
      name: 'Sustainability Tower (Enterprise)',
      price: '€9,960',
      sub1: 'Эко ивент €380',
      sub2: 'ESG-отчёт фикс. €450',
      sub3: 'За событие –€120 → <b>€830</b>',
      li1: 'Полная ESG-программа',
      li2: '12 событий в год · до 8 участников',
      li3: 'Полный ESG Data Pack + CSV/API-экспорт',
    ...
    modal: {
      lead_magnet: { label: 'ESG Data Pack', title: 'Скачать пример ESG Impact Report', submit: 'Получить отчёт', success_title: 'Отчёт уже в пути!', success_desc: 'PDF отчёт отправлен на ваш email. Свяжемся в течение 1 рабочего дня.' },
      hr_contact: { label: 'HR & Команды', title: 'Забронировать корпоративную уборку', submit: 'Получить предложение', success_title: 'Свяжемся в течение часа!', success_desc: 'Пришлём индивидуальное предложение с планом и сметой.' },
      ...
      field: {
        ...
        email: '\u0420\u0430\u0431\u043e\u0447\u0438\u0439 email',
        company: '\u041a\u043e\u043c\u043f\u0430\u043d\u0438\u044f',
        role_placeholder: 'Должность',
        role_cso: 'Sustainability manager',
        role_coo: 'ESG consultant',
        role_marketing: 'CFO / Финансовый директор',
        role_founder: 'Founder / Основатель',
        role_other: 'Другое',
  ...
  en: {
    ...
    pkg1: {
      ...
      price: '€950',
      sub1: 'Eco event €500',
      sub2: 'ESG report fix. €450',
      li0: 'Test ESG evidence',
      li1: '1 event - up to 6 participants',
    ...
    pkg2: {
      ...
      sub1: 'Eco event €450',
      sub2: 'ESG report fix. €450',
      sub3: 'Per event –€50 → <b>€900</b>',
      li1: 'Most popular',
      li2: '4 events a year · up to 8 participants',
      li3: 'ESG Data Pack after each event',
      li4: 'Annual impact summary for reporting',
      li5: 'Branding + photo/video + priority dates',
    ...
    pkg3: {
      ...
      sub1: 'Eco event €380',
      sub2: 'ESG report fix. €450',
      sub3: 'Per event –€120 → <b>€830</b>',
      li1: 'Full ESG program',
      li2: '12 events a year · up to 8 participants',
      li3: 'Full ESG Data Pack + CSV/API export',
  ...
  pt: {
    ...
    pkg1: {
      ...
      price: '€950',
      sub1: 'Evento eco €500',
      sub2: 'Relatório ESG fixo €450',
      li0: 'Teste de evidências ESG',
      li1: '1 evento - até 6 participantes',
      li2: 'Track GPS + foto + peso do lixo',
      li3: 'ESG Evidence Report (PDF) + Raw CSV',
    ...
    pkg2: {
      ...
      sub1: 'Evento eco €450',
      sub2: 'Relatório ESG fixo €450',
      sub3: 'Por evento –€50 → <b>€900</b>',
      li1: 'A escolha mais popular',
      li2: '4 eventos por ano · até 8 participantes',
      li3: 'ESG Data Pack após cada evento',
      li4: 'Resumo anual de impacto para relatório',
      li5: 'Branding + foto/vídeo + datas prioritárias',
    ...
    pkg3: {
      ...
      sub1: 'Evento eco €380',
      sub2: 'Relatório ESG fixo €450',
      sub3: 'Por evento –€120 → <b>€830</b>',
      li1: 'Programa ESG completo',
      li2: '12 eventos por ano · até 8 participantes',
      li3: 'Full ESG Data Pack + Exportação CSV/API',
